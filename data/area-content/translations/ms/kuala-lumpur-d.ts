...
export const translations: AreaTranslations = {
  "kuala-lumpur/kl-city-centre": {
    ...
    intro: [
      ...
      "Campuran itu menentukan jenis kerja. Pemilik dan penyewa di pusat bandar meminta kerja kemasan unit, naik taraf dapur dan bilik air, penggantian [lantai](/services/flooring), [kalis air](/services/waterproofing) balkoni dan bilik air, serta penambahan titik [elektrik](/services/electrical) untuk peralatan moden dan ruang kerja di rumah. Renovix bekerja mengikut peraturan renovasi setiap bangunan — permit, deposit, waktu dibenarkan, tempahan lif dan laluan sisa — kerana di teras bandar, peraturan itulah yang selalunya menentukan jadual, bukan skop kerja.",
    ],
    serviceNotes: [
  ...
  "kuala-lumpur/taman-desa": {
    ...
    intro: [
      ...
      "Usia kawasan inilah yang menentukan kerja. Pangsapuri walk-up dan rumah teres asalnya kini berusia berdekad, jadi bilik air, paip tersembunyi, pendawaian dan bumbung sampai ke tahap pembaikan bertukar menjadi penggantian. Kami menyediakan penggantian [paip](/services/plumbing), [pendawaian semula](/services/electrical), pembinaan semula bilik air dengan [kalis air](/services/waterproofing) yang betul, pembaikan [siling](/services/ceiling-partition) dan [kerja cat](/services/painting) di Taman Desa, di samping kerja kemasan di blok kondominium baharu.",
    ],
    serviceNotes: [
  ...
  "kuala-lumpur/kampung-baru": {
    ...
    intro: [
      ...
      "Kerja di sini lebih kepada pembaikan dan naik taraf berhati-hati berbanding pembinaan semula menyeluruh. Struktur kayu memerlukan perhatian pada reput, bumbung dan lantai; rumah batu lama perlukan pendawaian semula, penggantian paip dan pembaharuan bilik air; manakala pemilik rumah kedai meminta pengubahsuaian praktikal. Kami menyediakan [kerja kalis air](/services/waterproofing) dan pembaikan bumbung, [pendawaian](/services/electrical), [paip](/services/plumbing), [cat](/services/painting), [kerja besi](/services/welding-metal-works) serta [pembaikan handyman](/services/handyman) di Kampung Baru, dengan penilaian keadaan sebenar sebelum mencadangkan skop.",
    ],
    serviceNotes: [
