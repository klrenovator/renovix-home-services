...
export const translations: AreaTranslations = {
  "selangor/setia-alam": {
    ...
    intro: [
      ...
      "Oleh sebab stok perumahannya agak muda dan seragam, kerja di sini lebih mudah dijangka berbanding pekan lama. Rumah yang dibina dalam dekad pertama bandar ini kini sampai ke usia kalis air bilik air asal, cat luar dan butiran bumbung memerlukan perhatian, manakala pemilik merancang sambungan dapur, dapur basah, naik taraf porch dan pembaharuan dalaman menyeluruh. Kami menyediakan [renovasi am](/services/general-renovation), [kalis air](/services/waterproofing), [kerja jubin](/services/tiling), [elektrik](/services/electrical) dan [kerja besi](/services/welding-metal-works) di seluruh presint Setia Alam.",
    ],
    serviceNotes: [
  ...
  "selangor/bandar-kinrara": {
    ...
    intro: [
      ...
      "Usia bandar inilah fakta utama untuk kerja renovasi. Rumah yang dibina dalam dekad pertamanya kini berusia dua puluh hingga tiga puluh tahun — usia paip tersembunyi, kalis air bilik air, pendawaian dan butiran bumbung mula gagal satu demi satu. Kami menyediakan penggantian [paip](/services/plumbing), pembaharuan [kalis air](/services/waterproofing), [pendawaian semula](/services/electrical) dan naik taraf papan agihan, [kerja jubin](/services/tiling) serta [renovasi am](/services/general-renovation) di seluruh seksyen landed dan blok tinggi Bandar Kinrara.",
    ],
    serviceNotes: [
  ...
  "selangor/batu-caves": {
    ...
    intro: [
      ...
      "Campuran usia inilah yang membentuk kerja di sini. Rumah lama memerlukan pembaharuan bumbung, pendawaian dan bilik air; rumah teres 80-an–90-an sampai ke usia kalis air dan paip tersembunyi gagal; manakala hujan lebat yang mengalir dari kawasan tadahan bukit menjadikan butiran bumbung, saliran dan lembap luaran tema berulang di seluruh pekan. Kami menyediakan [kerja kalis air](/services/waterproofing) dan bumbung, [paip](/services/plumbing), [pendawaian](/services/electrical), [cat](/services/painting) serta [kerja besi](/services/welding-metal-works) di Batu Caves.",
    ],
    serviceNotes: [
  ...
  "selangor/bandar-mahkota-cheras": {
    ...
    intro: [
      ...
      "Rumah di sini dibina dalam tempoh yang agak singkat, jadi ia menua serentak. Rumah generasi pertama bandar ini kini sampai ke tahap kalis air bilik air asal, cat luar, butiran bumbung dan papak porch memerlukan perhatian, manakala pemilik menambah dapur basah, menyambung ruang belakang dan memodenkan dalaman. Kami menyediakan [kerja kalis air](/services/waterproofing), [renovasi am](/services/general-renovation), [jubin](/services/tiling), [elektrik](/services/electrical) dan [paip](/services/plumbing) di seluruh presint bandar ini.",
    ],
    serviceNotes: [
