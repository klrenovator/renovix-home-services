...
export const translation: ServiceTranslation = {
  ...
  materials: [
    {
      title: "Perkakasan Pintu",
      description:
        "Engsel, kunci, tombol dan strike plate — engsel pintu RM80–180, tukar kunci RM120–280.",
    },
    {
      title: "Perkakasan Pemasangan",
      description:
        "Wall plug, skru dan bracket untuk TV, rak dan rel langsir — pemasangan TV RM150–300 termasuk bracket.",
    },
    {
      title: "Grout & Silikon",
      description:
        "Grout jubin dan silikon untuk bilik air dan dapur — grouting semula RM250–550, silikon RM80–180.",
    },
    {
      title: "Pemasangan Perabot Flat-Pack",
      description:
        "Almari, katil dan rak RM120–250 standard, unit dapur IKEA mengikut bilangan unit.",
    },
    {
      title: "Sealant & Touch-up",
      description:
        "Sealant, filler dan cat touch-up untuk pembaikan kecil — mengecat satu dinding RM200–500.",
    },
    {
      title: "Alat Asas",
      description:
        "Gerudi, spirit level, tangga dan silicone gun — kos kerja termasuk alat, bahan berasingan.",
    },
  ],
  costFactorsIntro:
    "Kos handyman bergantung pada jenis kerja, kemahiran diperlukan dan masa yang diambil.",
  costFactors: [
    {
    ...
    },
    {
      ...
      description:
        "Handyman am RM60–100 sejam, pakar elektrik atau paip lebih tinggi jika diperlukan.",
    },
    {
      title: "Tempoh",
      description:
        "Minimum 1 jam, kerja kecil boleh disebut harga tetap daripada gambar di WhatsApp, panggilan RM80 di tengah KL (diketepikan jika teruskan), RM150 di kawasan luar.",
    },
    {
      title: "Bahan & Bahagian",
      description:
        "Kos kerja tidak termasuk bahan; jenama kunci, jenis bracket dan luas grout mempengaruhi jumlah.",
    },
    {
      title: "Akses & Ketinggian",
      description:
        "Siling tinggi, keperluan tangga, jenis dinding konkrit atau drywall, tempahan lif kondominium.",
    },
    {
      title: "Bilangan Tugas",
      description:
        "Beberapa kerja kecil digabungkan boleh dikira sejam RM60–100, lebih menjimatkan berbanding kadar setiap kerja.",
    },
  ],
  duration: {
    ...
    note: "Kerja kecil dijadualkan mengikut beban kerja semasa; kami beri tarikh yang realistik semasa anda bertanya dan sahkan sebelum tiba.",
  },
  includes: [
    "Kos kerja dan alat asas untuk tugas yang dinyatakan",
    "Pemasangan, pembaikan, penjajaran dan ujian",
    "Pembersihan asas selepas kerja",
    "Sebut harga tetap daripada gambar di WhatsApp untuk kebanyakan kerja",
  ],
  excludes: [
    "Bahan, bracket, kunci dan grout kecuali dinyatakan",
    "Kerja pakar elektrik atau paip di luar skop handyman",
    "Mengecat satu bilik penuh selain touch-up (rujuk khidmat mengecat)",
    "Memindahkan perabot di luar kawasan kerja",
  ],
  includesTitle: "Apa yang biasanya termasuk dalam khidmat handyman",
  ...
  answerFirst: [
    ...
    },
    {
      ...
      answer:
        "Handyman merangkumi kerja kayu kecil, grouting, silikon, gantung gambar, pembaikan pintu dan kabinet, pemasangan TV, pemasangan perabot flat-pack, kerja kunci dan pintu, serta pembaikan dan pemasangan kecil. Kos kerja termasuk alat asas, bahan berasingan. Mengecat satu bilik penuh dirujuk kepada pasukan mengecat. Kebanyakan kerja boleh disebut harga tetap daripada gambar di WhatsApp.",
    },
    {
