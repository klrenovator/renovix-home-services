...
export const zh: Dictionary = {
  ...
  quote: {
    ...
    deliveryBody:
      "在线提交功能尚未对接，因此此表单不会发送您的资料或照片，也不会即时生成报价。若需立即联系，请拨打或通过 WhatsApp 联系 +601159259521，或发送电邮至 renovixhomeservices@gmail.com。",
    submittedBodyPrefix:
      "您的栏位已在此预览中完成检查。由于在线提交尚未对接，未发送任何资料。请拨打或通过 WhatsApp 联系 +601159259521，或使用",
    submittedLink: "联系页面",
    submittedBodySuffix: "，以便我们接收您的申请。",
    submit: "提交报价申请",
    asideEyebrow: "接下来的流程",
    ...
    statusTitle: "表单提交状态",
    statusBody:
      "在线提交功能尚未对接，因此本页面不会发送任何信息。WhatsApp、电话与电邮都能直接联系到我们：+601159259521 与 renovixhomeservices@gmail.com。",
