...
export const zh: Dictionary = {
  ...
  home: {
    hero: {
      ...
      imageAlt: "马来西亚住宅内已完成的石膏天花、灯带、筒灯与吊扇",
      imageTitle: "专业施工工艺",
  ...
  servicePage: {
    ...
    workShowcaseEyebrow: "我们的工程",
    workShowcaseTitle: "吉隆坡与雪兰莪近期的{name}工程",
    workShowcaseDescription: "Renovix 实际完成的{name}工程照片 — 非库存图片。",
    workShowcaseViewAll: "查看全部工程",
    startingPricesEyebrow: "起始价格",
    startingPricesTitle: "{name}价格一览",
    startingPricesDescription:
      "根据我们2026年市场调研的参考起始价。最终报价取决于现场状况、施工范围与材料。",
    startingPricesThisService: "{name}起价",
    startingPricesRelatedTitle: "相关服务 — 起始价格",
    startingPricesOnQuotation: "报价为准",
    startingPricesViewDetails: "查看价格详情",
  },
  subServicePage: {
    ...
    relatedSubPricesTitle: "其他{service}服务 — 起始价格",
  ...
  problemPage: {
    ...
    projectsEyebrow: "我们的工程",
    projectsTitle: "与{name}相关的工程实绩",
    projectsDescription: "来自我们作品集的真实拍摄工程，其工作范围确实涵盖此类问题。",
  ...
  contact: {
    ...
    ctaTitle: "告诉我们您需要的工程",
    ctaBody:
      "报价申请是说明服务、房屋、位置与简短描述最清楚的方式。",
    whatsappEyebrow: "WhatsApp 咨询",
    whatsappTitle: "更喜欢用 WhatsApp？",
    whatsappBody:
      "发送信息，附上几张照片与您的位置。WhatsApp 通常是最快说明维修并约定下一步的方式。",
    whatsappNote: "致电或 WhatsApp：",
    areasEyebrow: "服务范围信息",
    areasTitle: "吉隆坡、雪兰莪与巴生谷",
    areasLead:
      "Renovix 所列服务范围涵盖吉隆坡、雪兰莪及更大的巴生谷。请在咨询中注明您所在的地区或社区，以便我们结合当地情况考虑工程。",
  ...
  quote: {
    ...
    metaDescription:
      "向 Renovix 申请吉隆坡、雪兰莪与巴生谷的房屋装修、维修或改善报价。提供工程、房屋类型、位置与照片，有助于评估。",
    breadcrumb: "获取报价",
    eyebrow: "报价申请",
    title: "为您的房屋服务需求获取报价",
    description:
      "分享您所需的服务、房屋类型、位置与工程内容。有用的细节与照片有助于评估；报价不会即时生成。",
    heroPrimary: "开始报价申请",
    formTitle: "告诉我们工程详情",
    formLead:
      "您分享的细节越有用，越容易判断评估可能需要什么。",
    sections: {
      contact: "我们如何联系您？",
      job: "关于工程",
    },
    ...
    placeholders: {
      ...
      propertyType: "选择房屋类型",
      service: "选择服务",
      subService: "选择具体工程（选填）",
      subServiceDisabled: "请先选择服务",
      location: "地区、城市或社区",
      description:
        "说明您遇到的问题或工程，包括有用的尺寸、出入情况或时间安排。",
    },
    help: {
      phone: "我们联系您的号码——按您的偏好使用 WhatsApp 或来电。",
      email: "选填，除非您希望通过电邮联系。",
  ...
  blogIndex: {
    ...
    metaDescription:
      "面向吉隆坡与雪兰莪住宅的实用指南：装修费用、材料选择、维修与保养 —— 所有价格均取自我们公开的价目表，绝无杜撰数字。",
    ogDescription: "面向巴生谷住宅的费用指南、材料对比与维修诊断。",
    breadcrumb: "指南",
    title: "吉隆坡与雪兰莪住宅装修与维修指南",
    lead: "针对大家在找师傅之前最常问的问题给出直接答案：工程要多少钱、哪种材料适合哪个空间、如何分辨维修与重建，以及什么时候必须找专业人员。文中所有价格均来自我们公开的费率。",
    eyebrow: "知识中心",
    gridTitle: "浏览我们的指南",
    gridDescription:
      "每篇指南把一个问题讲透，并链接到相关的服务、问题与地区页面。",
    categoryEyebrow: "分类",
    readGuide: "阅读指南",
    ctaEyebrow: "开始咨询",
    ctaTitle: "还不确定自己需要哪种工程范围？",
    ctaDescription:
      "描述一下工程内容并发几张照片。我们会先根据实际情况告诉您方向，再谈报价。",
  },
  blogPage: {
    breadcrumbBlog: "指南",
    answerEyebrow: "简短回答",
    ...
    writtenByLabel: "撰写单位",
    pricingNote:
      "以下费率取自我们公开的价目表，均为起始价 —— 最终报价取决于实际现场情况与工程范围。",
    faqsEyebrow: "常见问答",
    faqsTitle: "关于这个主题，大家常问的问题",
    relatedServicesTitle: "本指南相关的服务",
    relatedSubServicesTitle: "本文涉及的具体工序",
    relatedProblemsTitle: "相关问题指南",
    relatedProjectsTitle: "相关工程案例",
    relatedAreasTitle: "我们承接此类工程的地区",
    relatedArticlesTitle: "相关指南",
    relatedAreasDescription: "此类工程较常出现的地区，附本地指南。",
    ctaHeading: "需要在吉隆坡或雪兰莪进行这项工程？",
    ctaDescription:
      "告诉我们房产状况与您看到的情况。我们会在准备报价之前先建议下一步该怎么做。",
  },
  guideLinks: {
    eyebrow: "知识中心",
    serviceTitle: "关于{name}的指南",
  ...
  legalPage: {
    ...
    privacySections: [
      ...
      },
      {
        title: "网站流量衡量",
        paragraphs: [
          "在启用流量衡量功能时，本网站使用 Google Analytics 以汇总方式了解哪些页面被浏览、哪些联系选项被使用。该衡量配置不会接收姓名、电话号码、电子邮件地址、报价表单内容或其他个人资料，并且广告功能已关闭。",
          "如启用会话录制工具 Microsoft Clarity，它将在默认的屏幕文字遮盖保持开启的状态下运行，录制中无法读取屏幕上的文字。您可以通过浏览器隐私设置或常见扩展程序拦截衡量脚本；即使拦截，本网站仍可正常使用。",
        ],
      },
      {
        title: "保存与安全",
