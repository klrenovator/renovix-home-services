...
export const zh: Dictionary = {
  ...
  contact: {
    ...
    title: "从您的房屋服务问题开始",
    description:
      "您可使用下方的联系方式，在号码启用后通过 WhatsApp 联系，或提交报价申请，说明吉隆坡、雪兰莪及巴生谷的工程需求。",
    heroPrimary: "开始报价申请",
    detailsEyebrow: "联系方式",
    detailsTitle: "与我们取得联系的方式",
    detailsLead:
      "在正式资料提供之前，联系方式刻意保留为占位符。我们并未假定任何电话号码、电邮、地址或营业时间。",
    channels: {
      phone: "电话号码",
      phoneHelper: "电话号码确认后，将补充通话详情。",
      whatsapp: "WhatsApp 号码",
      whatsappHelper: "号码确认后，将补充 WhatsApp 详情。",
      email: "电邮",
      emailHelper: "电邮地址确认后，将补充相关详情。",
      address: "地址",
      addressHelper: "服务范围见下方说明；目前尚未提供实体地址。",
      hours: "营业时间",
      hoursHelper: "营业时间确认后将予补充。",
    },
    ctaEyebrow: "联系我们",
    ctaTitle: "告诉我们您需要的工程",
    ctaBody:
    ...
    whatsappBody:
      "在提供正式号码后，WhatsApp 联系渠道即会启用。在此之前，此按钮会返回本联系页面，而不会尝试打开未经确认的号码。",
    whatsappNote: "WhatsApp 占位符：",
    areasEyebrow: "服务地区信息",
  ...
  quote: {
    ...
    help: {
      ...
      photos:
        "照片有助于评估。在安全的报价系统设置完成之前，照片不会被上传或发送。",
      photosChosen: "选择该区域的照片",
      requiredNote: "标示 * 的栏位，是准备报价申请所需的资料。",
    },
    photosPrompt: "上传照片",
    photosSelectedSuffix: "张照片",
    photosSelectedSuffixPlural: "张照片",
    deliveryTitle: "报价提交占位说明",
    deliveryBody:
      "此表单已可对接安全的报价申请系统，但目前尚未设置。提交此表单不会发送您的资料或照片，也不会即时生成报价。",
    submittedBodyPrefix:
      "您的栏位已在此前端预览中完成检查。由于报价提交尚未设置，未发送任何资料。请使用",
    submittedLink: "联系页面",
    submittedBodySuffix: "，直至报价接收渠道完成对接。",
    submit: "提交报价申请",
    asideEyebrow: "接下来的流程",
    ...
    statusTitle: "表单提交状态",
    statusBody:
      "此表单仅为前端架构。安全的后台系统、通知接收方与照片存储尚未设置，因此目前不会从本页面发送任何信息。",
  ...
  legalPage: {
    ...
    privacyTitle: "隐私政策",
    privacyDescription:
      "完整隐私政策将在后续阶段补充。联系方式在提供之前仍为占位符。",
    privacyMetaDescription: "Renovix Home Services 网站与服务的隐私政策。",
    termsTitle: "条款与条件",
    termsDescription:
      "完整条款与条件将在后续阶段补充。联系方式在提供之前仍为占位符。",
