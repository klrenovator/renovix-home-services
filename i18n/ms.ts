...
export const ms: Dictionary = {
  ...
  home: {
    hero: {
      ...
      highlights: [
        ...
        "Daripada pembaikan kecil oleh tukang am hingga renovasi penuh",
      ],
      imageAlt:
  ...
  search: {
    ...
    submit: "Cari",
    submitShort: "Cari",
    overlayTitle: "Cari di Renovix Home Services",
    closeOverlay: "Tutup carian",
    loading: "Mencari di dalam laman…",
    noResultsTitle: "Kami tidak menemui padanan untuk carian anda",
    noResultsBody:
      "Cuba perkataan lain, terangkan bilik atau masalah dengan lebih terperinci, atau pilih salah satu perkhidmatan popular di bawah.",
    popularServicesTitle: "Perkhidmatan popular",
    browseAllServices: "Layari semua perkhidmatan",
    browseAllProblems: "Layari semua masalah",
    describeMore: "Terangkan sendiri dengan kata-kata anda",
    describeMoreBody:
      "Hantar beberapa ayat kepada kami di WhatsApp — apa yang berlaku, bilik mana, dan bila lebih kurang anda perasan. Kami akan tunjuk orang yang tepat.",
    describeMoreCta: "Hantar mesej WhatsApp",
    requestQuote: "Atau minta sebut harga percuma",
    resultsHeading: "Keputusan untuk \"{query}\"",
    resultsHeadingNone: "Layari laman",
    resultsMeta: "Paparan {shown} daripada {total} padanan",
    whyMatched: "Mengapa ini sepadan",
    includesLabel: "Apa yang disertakan",
    processLabel: "Cara kerja dijalankan",
    relatedHeading: "Perkhidmatan berkaitan",
    faqCount: "{count} Soalan Lazim di halaman ini",
    faqCountNone: "Tiada Soalan Lazim di halaman ini",
    typeaheadRegion: "Cadangan carian",
    typeaheadHint: "Taip untuk mencari perkhidmatan, masalah, kawasan dan panduan…",
    exampleQueries: [
      "paip bocor",
      "jubin pecah",
      "elektrik terputus",
    ...
    auditDisclosure:
      "Keputusan diambil daripada maklumat yang sedia ada di laman web Renovix Home Services. Harga, bahan dan Soalan Lazim datang dari halaman yang sama — tiada apa-apa yang direka-reka.",
    notFoundPrompt: "Saya tidak jumpa apa yang saya perlukan",
  },
};
